...
8134 Writing programs (or programming) is a very creative 8557
and rewarding activity.  You can write programs for 
many reasons, ranging from making your living to solving
a difficult data analysis problem to having fun to helping
someone else solve a problem.  This book assumes that 
1050 everyone needs to know how to program, and that once 
...
7757 Programmers add an operating system and a set of applications
...
3224 programming can be a very rewarding job both financially and personally.
...
4056 process.   In some situations, when you choose a piece of software, the 8181
...
Central 723 Processing 3284 Unit 7699 (or CPU) is 
...
5267 retrieve data that might not always be up.  So in a sense, 8666
...
2166 each of these resources to solve the problem that you need to solve
...
6837 programmer --- perhaps not a professional programmer, but 5068
...
4531 Second, you need to tell a story.  In writing a story, 6017
...
3238 story writing is improved by doing some writing and getting some 9655
8003 feedback.  In programming, our program is the story and the 
problem you are trying to solve is the idea.

itemize

Once you learn one programming language such as Python, you will 
7390 find it much easier to learn a second programming language such 5970
...
4438 At some point you get your muse and see the patterns on your own
...
9616 human-to-dog language).  The nice thing about telling Python to speak
...
1737 Our sentence starts with the reserved word print followed 5734
...
8371 programmers with Python acting as an intermediary.  Python 1095
...
9986 Before we leave our first conversation with the Python 8021
...
1298 is represented all in zeros and ones.

1226 Machine language seems quite simple on the surface, given that there 
...
In 2247 this 5331 example, 3978 we ask Python to remember the value six and use the label x
...
it 179 runs 5337 a 894 process to translate the high-level source code into machine language
